...
extern void rb_marshal_VOID__UINT_STRING_STRING_OBJECT_BOOLEAN (GClosure     *closure,
                                                                ...
                                                                gpointer      marshal_data);
void
rb_marshal_VOID__UINT_STRING_STRING_OBJECT_BOOLEAN (GClosure     *closure,
                                                    GValue       *return_value G_GNUC_UNUSED,
                                                    guint         n_param_values,
                                                    const GValue *param_values,
                                                    gpointer      invocation_hint G_GNUC_UNUSED,
                                                    gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__UINT_STRING_STRING_OBJECT_BOOLEAN) (gpointer     data1,
                                                                        guint        arg_1,
                                                                        gpointer     arg_2,
                                                                        gpointer     arg_3,
                                                                        gpointer     arg_4,
                                                                        gboolean     arg_5,
                                                                        gpointer     data2);
  register GMarshalFunc_VOID__UINT_STRING_STRING_OBJECT_BOOLEAN callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__UINT_STRING_STRING_OBJECT_BOOLEAN) (marshal_data ? marshal_data : cc->callback);
